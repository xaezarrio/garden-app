...
<script type="text/javascript">
	...
	function deletedata(id) {
      ...
      var month = $("#month").val();
      var year = $("#year").val();
      <?php $akt = $this->mymodel->selectdataOne('aktivitas',array('name'=>'Pinjam')); ?>
      var akt = <?= $akt['id'] ?>;
      var url = "<?= base_url('koperasi/data') ?>?month="+month+"&year="+year+"&karyawan=<?= $karyawan_id ?>&id=<?= $id ?>&aktivitas="+akt;
      $("#load-data").load(url);
      $("#loading").hide();
    }
