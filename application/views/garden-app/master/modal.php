	...
	<div class="modal-dialog" role="document" style="z-index: 9999">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add New Modal</h4>
			</div>
		<form action="<?= base_url('master/modal/action/store') ?>" id="upload">
...
<div class="modal fade" id="editsite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document" style="z-index: 9999">
	    <div class="modal-content">
      	...
      	<form action="<?= base_url('master/modal/action/update') ?>" id="uploads">
...
<script type="text/javascript" src="<?= base_url('master/modal/js') ?>"></script>