...
<div class="modal fade" id="addsite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document" style="z-index: 9999">
		...
		<form action="<?= base_url('master/cost-center/action/store') ?>" id="upload">
...
<div class="modal fade" id="editsite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document" style="z-index: 9999">
	    <div class="modal-content">
      	...
      	<form action="<?= base_url('master/cost-center/action/update') ?>" id="uploads">
...
<script type="text/javascript" src="<?= base_url('master/cost-center/js') ?>"></script>