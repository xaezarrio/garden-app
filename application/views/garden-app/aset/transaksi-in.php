	...
	<section class="content">
		<div class="container">
			<div class="row no_margin">
				<h3 class="jdl_page">
					TRANSAKSI MASUK
					<a href="<?= base_url('aset/transaksi/in/add') ?>">
...
<script>
 ...
 function loaddata(url="") {
 		if(url!=null){
         	var urls = "<?= base_url('aset/transaksi/in/json') ?>"+url;
         }else{
         	var urls = "<?= base_url('aset/transaksi/in/json') ?>";
         }
     ...
     function edit(id) {
     	window.location.href = "<?= base_url('aset/transaksi/in/edit/') ?>"+id;
     }

     function hapus(id) {
     	if (confirm('Are you sure delete this data ?')) {
     		window.location.href = "<?= base_url('aset/transaksi/in/delete/') ?>"+id;		
		} else {
		    return false
		}
