	...
	<section class="content">
		<div class="container">
			<div class="row no_margin">
				<h3 class="jdl_page">LIST MATTERS</h3>
			</div>
			<div class="row">
				<div class="col-xs-12">
			            ...
			            <table class="table table-condensed table-hover table-bordered" id="example1">
			              ...
			              <tbody>
			                ...
			                <tr>
			                  ...
			                  <td>
			                  	<a href="<?= base_url('matters/detail/'.$p->pr_id) ?>" class="btn btn-xs btn-default btn-flat" ><i class="fa fa-file-text-o"></i>detail</a>
			                  	<a href="<?= base_url('matters/edit/'.$p->pr_id) ?>" class="btn btn-xs btn-primary btn-flat" ><i class="fa fa-edit"></i>edit</a>
			                  	<a href="#" class="btn btn-xs btn-danger btn-flat" onclick="return confirm('Yakin menghapus matter?')"  ><i class="fa fa-remove"></i></a>
			                  </td>
			                </tr>
			              	<?php endforeach ?>
