				...
				<div class="col-xs-4">
					<div class="box box-primary">
					  <div class="box-header with-border">	
						<b style="font-size: 16px;">Timesheets - (1801.0001 - Hak Cipta)</b>
					  </div>	
			          <div class="box-body">
					  ...
					  <div class="box-body">
							...
							<div class="tab-content">
							  <div id="home" class="tab-pane fade in active">
							    ...
							    <br><br>
							    <input type="checkbox" name="">*Centang ini sebelum mengajukan semua activity ke partner
							    <button class="btn btn-default btn-block btn-flat"><i class="fa fa-arrow-right"></i> Ajukan Timesheet Ke Partner</button>
							  </div>
							  <!-- end tab 1 -->
